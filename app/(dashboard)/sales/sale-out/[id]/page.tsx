  ...
  return (
    <div>
      ...
      <section className="grid gap-4 md:grid-cols-4">
        ...
        <div className="card p-5"><p className="text-sm text-gray-500">Net Amount</p><p className="mt-2 text-2xl font-black text-orange-700">฿{formatDocumentMoney(report.net_amount)}</p></div>
      </section>
