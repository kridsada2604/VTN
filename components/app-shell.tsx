...
export function AppShell({ children, email }: { children: React.ReactNode; email?: string }) {
  return <div className="min-h-screen lg:grid lg:grid-cols-[260px_1fr]">
    ...
    <div>
      <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-white/90 px-5 backdrop-blur sm:px-8"><div><p className="text-xs font-bold text-orange-600">VTN BUSINESS</p><p className="font-bold">ระบบบริหารธุรกิจ</p></div><div className="rounded-full bg-orange-100 px-3 py-1.5 text-xs font-bold text-orange-700">Phase 1.4</div></header>
