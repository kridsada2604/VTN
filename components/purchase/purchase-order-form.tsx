...
export function PurchaseOrderForm({
  ...
  const emptyItem: Item = { product_id: "", description: "", quantity: 1, unit_cost: 0, discount_percent: 0, tax_rate: isVatRegistered ? taxDefaults.default_vat_rate : 0 };
  ...
  return (
    <form action={action} className="card space-y-5 p-5">
      ...
      <div className="form-grid">
        ...
        {isVatRegistered && (
          <label>
            <span className="label">ภาษีซื้อ</span>
